...
Object.defineProperty(module, "exports", {
    get: function () {
        var opts        = (sake.options = require("sake/options")),
            useSync     = opts.synchronous,
            taskFn      = useSync ? defineTaskSync : defineTask,
            taskSyncFn  = useSync ? defineTask : defineTaskSync,
            fnSfx       = useSync ? "Async" : "Sync"
        ;
        ...
        sake.task               = taskFn.bind(sake, Task);
        sake["task" + fnSfx]    = taskSyncFn.bind(sake, Task);
        
        sake.file               = taskFn.bind(sake, Task);
        sake["file" + fnSfx]    = taskSyncFn.bind(sake, Task);
        
        sake.fileCreateSync         = taskFn.bind(sake, FileCreateTask);
        sake["fileCreate" + fnSfx]  = taskSyncFn.bind(sake, FileCreateTask);
