...
parsedOpts = nomnom.
    script(pkgInfo.name).
    help(wordwrap(88)(
        "Sake searches the current directory, and all parent directories, for " +
        "a Sakefile, unless --no-search is specified. Otherwise, if defined " + 
        "and --no-system is not set, it searches paths in the SAKE_PATH " +
        "environment variable.\n\n" +

        "If found through normal searching, and not in SAKE_PATH, sake changes " +
        "the process current working directory to the directory of the found " +
        "Sakefile, otherwise it stays where it was run from.\n\n" +
        
        "Sake then invokes the specified TASK, or the \"default\" one.\n\n" +
        
        "Sakefile can be one of \"Sakefile\", or \"sakefile\", with an " +
        "optional extension of \".js\", or \".coffee\". (If you wan't to run a " +
        "coffe-script file though, you will have to use the \".coffee\" extension.)"
    )).
